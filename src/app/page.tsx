...
export default function LandingPage() {
  ...
  const structuredData = {
    ...
    description:
      "Professional debt recovery and collection services in Kolkata and West Bengal. Specialized in NPA recovery, field collection, telecalling, and LAP recovery.",
    url: "https://3rdeyedms.com",
    logo: "https://3rdeyedms.com/logo.png",
    ...
    contactPoint: [
      ...
      {
        "@type": "ContactPoint",
        telephone: "+91-7044592088",
        contactType: "customer service",
        areaServed: "IN",
        availableLanguage: ["English", "Hindi", "Bengali"],
      },
    ],
    email: "response.3edms.ss@gmail.com",
    serviceArea: {
      "@type": "GeoCircle",
      geoMidpoint: {
        "@type": "GeoCoordinates",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            "@type": "Service",
            name: "Field Collection Services",
            description:
              "Professional field agents for direct customer engagement and debt recovery operations",
          },
        },
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Comprehensive personal loan debt recovery through combined field and telecalling approaches",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Two Wheeler Recovery",
            description:
              "Comprehensive two wheeler loan debt recovery through combined field and telecalling approaches",
          },
        },
      ],
    },
    ...
    sameAs: [
      "https://www.linkedin.com/company/3rd-eye-debt-management-service",
      "https://www.facebook.com/3rdeyedms",
    ],
  };
              ...
              <div className="relative bg-gradient-to-br from-primary to-secondary rounded-2xl p-6 sm:p-8 md:p-12 text-primary-foreground shadow-xl reveal-on-scroll opacity-0 translate-y-6 transition-all duration-700">
                <div className="text-center">
                  ...
                  <p className="text-white/80 text-sm sm:text-base md:text-lg leading-relaxed">
                    State-of-the-art facilities designed for optimal debt
                    recovery operations with modern technology and professional
                    workspace.
                  </p>
                </div>
              </div>
                  ...
                  <CardHeader className="p-0 m-0">
                    <div className="relative w-full h-64 sm:h-72 md:h-80 overflow-hidden">
                      {leader.image && (
                        <Image
                          src={leader.image}
                          alt={`${leader.name} - ${leader.role} at 3rd Eye Debt Management Service`}
                          fill
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                >
                  ...
                  <p className="text-slate-600 text-sm sm:text-base md:text-lg leading-relaxed">
                    ...
                    exceptional debt recovery results through strategic planning
